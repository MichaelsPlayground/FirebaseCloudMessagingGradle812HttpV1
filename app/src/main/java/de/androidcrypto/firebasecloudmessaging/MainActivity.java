...
public class MainActivity extends AppCompatActivity {
    ...
    private com.google.android.material.textfield.TextInputEditText etRecipient, etMessage, etMessageTitle;
    private com.google.android.material.textfield.TextInputLayout etMessageLayout, etMessageTitleLayout;

    private Button signIn, signOut, listUser;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etMessageLayout.setEndIconOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String messageTitleString = "from " + currentUserDisplayName + ": "  + etMessageTitle.getText().toString();
                ...
                FcmNotificationsSenderHttpV1 fcmNotificationsSender = new FcmNotificationsSenderHttpV1(MainActivity.this);
    ...
    public  void createNotificationChannel(@NonNull Context context) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            channel.setSound(customSoundUri2, audioAttributes);
            ...
            FirebaseMessaging.getInstance().getToken()
                    .addOnCompleteListener(new OnCompleteListener<String>() {
                        ...
                        public void onComplete(@NonNull Task<String> task) {
                            ...
                            currentUserDisplayName = uName; // use this for the notification title
